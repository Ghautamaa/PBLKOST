                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-4 border border-top-0 rounded-bottom">
                                                    ...
                                                    <a href="<?= base_url('Cdaftarkost/detailKost_penyewa/' . $item->id_kost); ?>" class="btn border border-secondary rounded-pill px-3 text-info"><i class=" me-2 text-info"></i> Cek Kost!</a>
                                            </div>
                                        </div>
                                    </div>
