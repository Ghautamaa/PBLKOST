                ...
                <div class="row g-4 mb-5">
                    <div class="col-lg-8 col-xl-9">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                <h4 class="text-bold fs-9 fw-bold mb-3">Kost <?php echo $kost_detail->namaKost; ?></h4>
                                <p class="text-dark fs-9 mb-3"><?php echo $kost_detail->alamatKost; ?></p>
                                <h5 class="text-dark fs-9 mb-3"><?php echo "Rp.".number_format("$kost_detail->hargaKost",2,",",".") ?>/ Bulan</h5>
