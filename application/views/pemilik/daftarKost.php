     ...
     <!-- <img src="your-image-here.jpg"> -->
      <div class="row justify-content-center">
        <div class="formbold-mb-3">
          <h2><center>Form Pendaftaran Kost</center></h2>
        </div>
      </div>
    <form name="daftarkost" method="POST" action="<?php echo base_url ('cdaftarkost/simpan_daftarkost'); ?>" enctype="multipart/form-data">
              <?php
            ...
            <p class="hilang"><?php echo $this->session->userdata('nomor_whatsapp')?></p>
            <!-- <label>Email :</label> -->
            <p class="hilang"><?php echo $this->session->userdata('alamat_email')?></p>
      ...
      <div class="formbold-form-file-flex" required>
        <label  class="formbold-form-label">
          Gambar Kost :
        </label>
        <input
      ...
      <a href="<?php echo base_url ('ctampilan/dashboard_pemilik'); ?>"><button type="button" class="formbold-btn2">Kembali</button></a>
    </form>
  </div>
</div>
<style>
